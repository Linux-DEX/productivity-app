...
const Sidebar: React.FC<SidebarProps> = ({ children }) => {
  ...
  return (
    <aside className="h-screen">
      <nav className="h-full inline-flex flex-col shadow-sm bg-surface border-r-1 border-default">
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-surface"
          >
            {expanded ? (
        ...
        <div className="flex items-center p-3 border-t border-default">
          <img
          ...
          >
            <div className="leading-4 text-primary-text">
              ...
              <span className="text-xs text-secondary">linuxdex@linux.com</span>
            </div>
            <ThemeSwitch />
          </div>
        </div>
